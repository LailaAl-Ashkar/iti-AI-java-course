...
public class SmileDemoEDA {
    ...
    public static void main(String[] args) throws IOException {
        ...
        DataFrame testData = pProvider.readCSVTest(sd.testPath);
        ...
        //int[] desired = testData.column("Survived").toIntArray();
        System.out.println ("=======After Omitting null Rows==============");
        System.out.println (testData.summary ());
        System.in.read();
        ...
        RandomForest testModel = RandomForest.fit(Formula.lhs("Survived"), testData);
        System.out.println("feature importance:");
        System.out.println(Arrays.toString(testModel.importance()));
        System.out.println(testModel.metrics ());

        int[] testPrediction = model.predict(testData); //model.test(testData);
        System.out.println("=================Testing Predictions==================");
        System.out.println(Arrays.toString(testPrediction));
        //System.out.println(Accuracy.of(desired, testPrediction));
